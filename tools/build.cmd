...
"%ProgramFiles%\dotnet\dotnet.exe" msbuild "..\FileMagic.sln" -t:restore -p:Configuration=%releaseconfig%
...
"%ProgramFiles%\dotnet\dotnet.exe" msbuild "..\FileMagic.sln" -p:Configuration=%releaseconfig%
